...
# train_llama.py saves to ./lora_llama_v3_final (run from Lora LLM/llama3/)
LORA_DIR = BASE_DIR / "llama3" / "lora_llama_v3_final"
TEST_FILE = DATA_DIR / "test.jsonl"
OUTPUT_REPORT = BASE_DIR / "metrics" / "lora_llama3_report.json"
NUM_SAMPLES = 200
...
# MUST match the original seed to compare apples-to-apples!
random.seed(42)
test_data = random.sample(all_data, min(NUM_SAMPLES, len(all_data)))

print(f"\n4. Starting Inference against Llama-3 LoRA...")
results = []
metrics = {
    "total": len(test_data),
    "valid_json": 0,
...
print("\n" + "="*50)
print(f"       LLAMA-3 LORA EVALUATION METRICS       ")
print("="*50)
