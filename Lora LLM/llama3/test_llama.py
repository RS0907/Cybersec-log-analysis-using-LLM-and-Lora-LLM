...
lora_dir = str(BASE_DIR / "lora_llama_v3_final")
...
print("\n" + "="*50)
print(" 🚀 INTERACTIVE LLAMA-3 LORA CHAT LAUNCHED 🚀")
...
while True:
    ...
    # Format exactly how the Llama model was instructed during training
    messages = [
