...
print("3. Loading Base Llama-3 Model...")
...
print("4. Applying LoRA specifically for Llama Architecture...")
...
trainer.save_model("./lora_llama_v3_final")
tokenizer.save_pretrained("./lora_llama_v3_final")

print("✅ Llama LoRA training complete and saved to ./lora_llama_v3_final")
